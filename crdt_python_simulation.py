...
class WordClone:
    def __init__(self, root):
        self.root = root
        self.root.title("MINI WORD C & PYTHON")
        ...
        # Image & Recherche
        tk.Button(toolbar, text="🖼 Image", command=self.add_img).pack(side=tk.LEFT, padx=5)
        ...
        tk.Button(toolbar, text="🔍", command=self.search).pack(side=tk.LEFT)
